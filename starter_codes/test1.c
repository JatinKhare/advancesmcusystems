...
#define PS_APLL_CTRL_ADD    0xFD1A0020
#define PS_APLL_CFG_ADD     0xFD1A0024
#define PS_PLL_STATUS_ADD   0xFD1A0044
...
int main(int argc, char *argv[]) {
    ...
    seed_ps= 0/*rand() % 5*/;
/*
    uint32_t *ps_clk_ctrl, *ps_clk_cfg, *ps_clk_status;
    switch(seed_ps){
	    ...
	    case 0:
		    ...
		    ps_clk_ctrl   = mmap(NULL, 
				       0x1000,
				       PROT_READ|PROT_WRITE,
				       MAP_SHARED, dh, 0xFF5E0000 //PS_APLL_CTRL_ADD 
				       & ~MAP_MASK);
	           
		    ps_clk_cfg    = mmap(NULL, 
				       0x1,
				       PROT_READ|PROT_WRITE,
				       MAP_SHARED, dh, PS_APLL_CFG_ADD & ~MAP_MASK);
		    
		    ps_clk_status = mmap(NULL, 
				       0x1,
				       PROT_READ|PROT_WRITE,
				       MAP_SHARED, dh, PS_PLL_STATUS_ADD & ~MAP_MASK);
		    ...
		    *ps_clk_ctrl = (*ps_clk_ctrl) & 0xFFFFFFF7;
		    ...
		    munmap(ps_clk_cfg, 0x1000);
		    munmap(ps_clk_status, 0x1000);
	    ...
	    case 1:
		    ...
		    ps_clk_ctrl   = mmap(NULL, 
				       0x1000,
				       PROT_READ|PROT_WRITE,
				       MAP_SHARED, dh, PS_APLL_CTRL_ADD & ~MAP_MASK);
    ...
    switch(seed_pl){
	    ...
	    case 0:
		    ...
		    pl_clk_reg = mmap(NULL, 
	            ...
	            pl0 = pl_clk_reg + (((PL0_REF_CTRL_ADD) & MAP_MASK) >> 2;
